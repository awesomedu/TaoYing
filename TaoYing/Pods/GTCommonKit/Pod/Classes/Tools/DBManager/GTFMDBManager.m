...
@implementation GTFMDBManager

static GTFMDBManager *gtDb = nil;
+ (instancetype)shareDataBase{
    return [GTFMDBManager shareDataBase:nil];
}

+ (instancetype)shareDataBase:(NSString *)dbName{
    return [GTFMDBManager shareDataBase:dbName path:nil];
}
...
- (BOOL)gt_createTable:(NSString *)tableName dicOrModel:(id)parameters{
    return [self gt_createTable:tableName dicOrModel:parameters excludeName:nil];
}
...
{
    return [self gt_alterTable:tableName dicOrModel:parameters excludeName:nil];
}

- (BOOL)gt_alterTable:(NSString *)tableName dicOrModel:(id)parameters excludeName:(NSArray *)nameArr
{
    __block BOOL flag;
    [self gt_inTransaction:^(BOOL *rollback) {
        if ([parameters isKindOfClass:[NSDictionary class]]) {
